  ...
  return <>
    ...
    <main className="videos-page">
      <section className="videos-intro">
        <div><p className="section-kicker">DOCTOR PEP / EN VIDEO</p><h1>Más cerca.<br/><em>En cada video.</em></h1><p>Un espacio para las publicaciones de Doctor Pep en TikTok e Instagram.</p><a className="video-back" href={home + '#catalogo-completo'}>← Volver al catálogo</a></div>
        <div className="video-brand-panel"><img src={logo} width="280" height="280" alt="Logo de Doctor Pep"/><span>@doctor.pep.26</span><div><SocialIcon platform="tiktok"/><span aria-hidden="true">+</span><SocialIcon platform="instagram"/></div></div>
      </section>
      ...
      <section className="video-catalog-return"><h2>¿Buscas un producto?</h2><p>Vuelve al catálogo para revisar sus presentaciones y preparar tu consulta.</p><a href={home + '#catalogo-completo'}>Explorar catálogo →</a></section>
    </main>
